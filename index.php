<?php 
/*
 Plugin Name: VW Bakery Pro Posttype
 lugin URI: https://www.vwthemes.com/
 Description: Creating new post type for VW Bakery Pro Theme.
 Author: VW Themes
 Version: 1.1
 Author URI: https://www.vwthemes.com/
*/

define( 'VW_BAKERY_PRO_POSTTYPE_VERSION', '1.0' );
...
function vw_bakery_pro_posttype_create_post_type() {
  register_post_type( 'testimonials',
    array(
  		'labels' => array(
  			'name' => __( 'Testimonials','vw-bakery-pro-posttype' ),
  			'singular_name' => __( 'Testimonials','vw-bakery-pro-posttype' )
  		),
  ...
  register_post_type( 'team',
    array(
      'labels' => array(
        'name' => __( 'Our Team','vw-bakery-pro-posttype' ),
        'singular_name' => __( 'Our Team','vw-bakery-pro-posttype' )
      ),
        'capability_type' => 'post',
        'menu_icon'  => 'dashicons-businessman',
        'public' => true,
...
function vw_bakery_pro_posttype_bn_testimonial_meta_box() {
	add_meta_box( 'vw-bakery-pro-posttype-testimonial-meta', __( 'Enter Details', 'vw-bakery-pro-posttype' ), 'vw_bakery_pro_posttype_bn_testimonial_meta_callback', 'testimonials', 'normal', 'high' );
}
	...
	<div id="testimonials_custom_stuff">
		<table id="list">
			<tbody id="the-list" data-wp-lists="list:meta">
				<tr id="meta-1">
					<td class="left">
						<?php _e( 'Designation', 'vw-bakery-pro-posttype' )?>
					</td>
					<td class="left" >
...
function vw_bakery_pro_posttype_bn_team_meta() {
    add_meta_box( 'vw_bakery_pro_posttype_bn_meta', __( 'Enter Details','vw-one-page-pro-posttype' ), 'vw_bakery_pro_posttype_ex_bn_meta_callback', 'team', 'normal', 'high' );
}
// Hook things in for admin
if (is_admin()){
...
function vw_bakery_pro_posttype_team_func( $atts ) {
    ...
    $team = '<div class="team_sc row">';
      ...
      if ( $new->have_posts() ) :
        ...
        $team = '<div id="team" class="team_wrap col-md-3 mt-3 mb-4"><h2 class="center">'.__('Not Found','vw-bakery-pro-posttype').'</h2></div>';
      endif;
    return $team;
}
...
function vw_bakery_pro_posttype_testimonials_func( $atts ) {
    ...
    $testimonial = '<div id="testimonials"><div class="testimonial-shortcode row">';
      ...
      if ( $new->have_posts() ) :
        ...
        $testimonial = '<div id="testimonial" class="testimonial_wrap col-md-3 mt-3 mb-4"><h2 class="center">'.__('Not Found','vw-bakery-pro-posttype').'</h2></div></div></div>';
      endif;
    return $testimonial;
}
